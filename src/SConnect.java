...
public class SConnect {
    ...
    public SConnect(String url, String user, String password) {
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            //Step-1: get a connection to the db
 ...
 public ResultSet getResultSet() {
        try {
            String query = "select email, mob_no,id,password,subj from information;";
...
//        try {
//            String query = "insert into studentdb(email, mob_, department, program) values('" +
